...
export default function EcoChallengeDetail() {

  const { title } = useParams<{ title: string }>();

  console.log("lline 10", title);

  const challenge = ChallengeData.EcoChallenges.find(
          ...
          <div className="grid lg:grid-cols-2 xs:grid-cols-1 gap-x-7 gap-y-5">
            {challenge.instructions?.steps.map((step, index) => (
              ...
              >
                ...
                <div className="sm:px-10 xs:px-6 md:px-8 sm:text-lg xs:text-base !leading-9">
                  <ul>
