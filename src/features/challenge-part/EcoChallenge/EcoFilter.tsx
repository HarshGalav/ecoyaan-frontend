...
import AllEcoChallenge from "./AllEcoChallenge";
...
export default function EcoFilter() {
                  ...
                  <div className="border border-gray-400 rounded-xl p-2 gap-y-5 flex flex-col xl:!px-7 lg:!px-7 md:!px-5 sm:!px-3 xs:!px-2  py-4">
                    ...
                    <div className=" flex md:gap-x-4 sm:gap-x-2 xs:gap-x-1 flex-wrap gap-y-2">
                      {filterCategories.map((challenge, index) => (
                        <button
                          key={index}
                            className={`hover:bg-[#77aebf] hover:text-white rounded-2xl border-gray-400 border p-1 lg:!px-5 md:!px-4 sm:!px-5 xs:!px-3 xs:text-base ${
                  ...
                  <div>
                    <button
                      onClick={handleApplyFilters}
                         className="rounded-xl bg-[#50B166] text-white  border px-9 xl:text-2xl xs:text-xl py-1"
                    >
                      Apply
                    </button>
                  </div>
